...
def make_opcodes():
    opcodes = {
        ...
        0xAE: Opcode(Opcode.NUM_ARGS_ZERO, Function('scas', 'flags'), 'scasb', shorthand2='Reg8(0)'),
        0xAF: Opcode(Opcode.NUM_ARGS_ZERO, Function('scas', 'flags'), 'scasw', shorthand2='Reg16(0)'),
