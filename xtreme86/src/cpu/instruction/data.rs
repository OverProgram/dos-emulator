...
impl Opcode {
	pub fn get_opcode_data() -> [Option<Opcode>; 256] {
		[
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::add), mnemonic: Mnemonic::Static(String::from("add")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::or), mnemonic: Mnemonic::Static(String::from("or")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::adc), mnemonic: Mnemonic::Static(String::from("adc")), shorthand1: Some(Placeholder::Reg8(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::and), mnemonic: Mnemonic::Static(String::from("and")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::sub), mnemonic: Mnemonic::Static(String::from("sub")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::xor), mnemonic: Mnemonic::Static(String::from("xor")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			...
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(flags::cmp), mnemonic: Mnemonic::Static(String::from("cmp")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(flags::cmp), mnemonic: Mnemonic::Static(String::from("cmp")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(int::bound), mnemonic: Mnemonic::Static(String::from("bound")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			None,
			...
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::alu_dispatch_two_args), mnemonic: Mnemonic::Dynamic(Rc::new(alu::alu_dispatch_two_args_mnemonic)), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::lea), mnemonic: Mnemonic::Static(String::from("lea")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			...
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(mem::nop), mnemonic: Mnemonic::Static(String::from("nop")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			None,
			...
			None,
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(1)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(2)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(3)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(4)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(5)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(6)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg8(7)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(1)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(2)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(3)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(4)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(5)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(6)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: Some(Placeholder::Reg16(7)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			None,
			None,
			Some(Opcode{ num_args: NumArgs::One, action: Rc::new(stack::ret), mnemonic: Mnemonic::Static(String::from("ret")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ Immediate | ForceWord  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::ldw), mnemonic: Mnemonic::Static(String::from("les")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::ES }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::ldw), mnemonic: Mnemonic::Static(String::from("lds")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::mov), mnemonic: Mnemonic::Static(String::from("mov")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			...
			Some(Opcode{ num_args: NumArgs::One, action: Rc::new(jmp::jmp), mnemonic: Mnemonic::Static(String::from("jmp")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::CS }),
			None,
			None,
			None,
			None,
