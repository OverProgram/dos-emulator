...
impl Opcode {
	pub fn get_opcode_data() -> [Option<Opcode>; 256] {
		[
			...
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(flags::scas), mnemonic: Mnemonic::Static(String::from("scasb")), shorthand1: None, shorthand2: Some(Placeholder::Reg8(0)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(flags::scas), mnemonic: Mnemonic::Static(String::from("scasw")), shorthand1: None, shorthand2: Some(Placeholder::Reg16(0)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
