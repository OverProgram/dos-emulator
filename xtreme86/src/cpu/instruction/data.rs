...
impl Opcode {
	pub fn get_opcode_data() -> [Option<Opcode>; 256] {
		[
			...
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(flags::test), mnemonic: Mnemonic::Static(String::from("test")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::xchg), mnemonic: Mnemonic::Static(String::from("xchg")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			None,
			...
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::xchg), mnemonic: Mnemonic::Static(String::from("xchg")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: Some(Placeholder::Reg16(1)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::xchg), mnemonic: Mnemonic::Static(String::from("xchg")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: Some(Placeholder::Reg16(2)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::xchg), mnemonic: Mnemonic::Static(String::from("xchg")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: Some(Placeholder::Reg16(3)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::xchg), mnemonic: Mnemonic::Static(String::from("xchg")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: Some(Placeholder::Reg16(4)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::xchg), mnemonic: Mnemonic::Static(String::from("xchg")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: Some(Placeholder::Reg16(5)), flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			...
			Some(Opcode{ num_args: NumArgs::One, action: Rc::new(stack::far_call), mnemonic: Mnemonic::Static(String::from("call")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ ForceDWord | Immediate }), segment: Regs::DS }),
			None,
			...
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(flags::cmps), mnemonic: Mnemonic::Static(String::from("cmpsb")), shorthand1: Some(Placeholder::Byte(0)), shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(flags::cmps), mnemonic: Mnemonic::Static(String::from("cmpsw")), shorthand1: Some(Placeholder::Word(0)), shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(flags::test), mnemonic: Mnemonic::Static(String::from("test")), shorthand1: Some(Placeholder::Reg(0)), shorthand2: Some(Placeholder::Imm), flags: make_bitflags!(OpcodeFlags::{ Immediate }), segment: Regs::DS }),
			None,
			...
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(flags::scas), mnemonic: Mnemonic::Static(String::from("scasb")), shorthand1: Some(Placeholder::Reg8(0)), shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::ES }),
			Some(Opcode{ num_args: NumArgs::Zero, action: Rc::new(flags::scas), mnemonic: Mnemonic::Static(String::from("scasw")), shorthand1: Some(Placeholder::Reg16(0)), shorthand2: None, flags: make_bitflags!(OpcodeFlags::{  }), segment: Regs::ES }),
			...
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(alu::rotate_dispatch), mnemonic: Mnemonic::Dynamic(Rc::new(alu::rotate_dispatch_mnemonic)), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ Immediate | ForceByte | SizeMismatch }), segment: Regs::DS }),
			None,
			...
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::les), mnemonic: Mnemonic::Static(String::from("les")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ ForceDWord }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::Two, action: Rc::new(mem::lds), mnemonic: Mnemonic::Static(String::from("lds")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ ForceDWord }), segment: Regs::DS }),
			...
			Some(Opcode{ num_args: NumArgs::One, action: Rc::new(jmp::jmp), mnemonic: Mnemonic::Static(String::from("jmp")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ Immediate | ForceWord }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::One, action: Rc::new(jmp::jmp_far), mnemonic: Mnemonic::Static(String::from("jmp")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ Immediate | ForceDWord }), segment: Regs::DS }),
			Some(Opcode{ num_args: NumArgs::One, action: Rc::new(jmp::jmp), mnemonic: Mnemonic::Static(String::from("jmp")), shorthand1: None, shorthand2: None, flags: make_bitflags!(OpcodeFlags::{ Immediate | ForceByte }), segment: Regs::DS }),
			None,
			None,
			None,
			None,
