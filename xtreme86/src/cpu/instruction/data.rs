...
type OpcodeMnemonic = Rc<dyn Fn(u8) -> String>;
...
impl Opcode {
    const fn new(num_args: NumArgs, action: OpcodeAction) -> Self {
        Self {
            num_args,
            action,
            ...
            shorthand2: None,
            segment: Regs::DS,
            mnemonic: Rc::new(|_: u8| String::from(""))
        }
    }
    ...
    fn set_mnemonic_func(mut self, mnemonic: OpcodeMnemonic) -> Self {
        self.mnemonic = mnemonic;
        self
    }

    fn set_mnemonic_str(mut self, mnemonic: &str) -> Self {
        self.mnemonic = Rc::new(move |_: u8| String::from(mnemonic));
        self
    }
